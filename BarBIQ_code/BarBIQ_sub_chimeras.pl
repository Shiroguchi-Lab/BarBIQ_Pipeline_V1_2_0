...
##read command##
my $threshold_d=0.1; ## this is a threshold to delete the chimeras which the portion of chimeras only is lower than 10%
...
print "Now you are runing $0\n";
print "The parameters are: @ARGV\n";
print "Your are using the threshold of $threshold_d to delete the chimeras\n";
